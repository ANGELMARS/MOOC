...
<body>
<%
   // String url = "courseAction_findteacherAllCourse?tna="+ username;
   // response.sendRedirect(url);
%>
<h1>登录成功</h1>
<form action="courseAction_findteacherAllCourse" method="post" name="dd">
    <input  type="text" name="tna" hidden="hidden"
