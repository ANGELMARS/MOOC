    ...
    <div id="main">
        <div id="main_container">
            ...
            <div class="page">
                ...
                <a href="courseAction_searchCourse?info=<%=i%>&pageindex=1">首页</a>
                <a href="courseAction_searchCourse?info=<%=i%>&pageindex=<s:property value="pageindex-1"/>">上一页</a>
                <a href="courseAction_searchCourse?info=<%=i%>&pageindex=<s:property value="pageindex+1"/>">下一页</a>
                <a href="courseAction_searchCourse?info=<%=i%>&pageindex=<s:property value="pageModel.pagecount"/>">尾页</a>
