    ...
    <div id="main">
        <div id="courselist_main_container">
            ...
            <a class="btn-style-01"<%--返回按钮--%>
               href="courseAction_findteacherCourse?cid=<s:property escape="false" value="pageModel.datas_c.{id}[0]"/>"
            >返回</a>
            <br>
        ...
        <div class="page">
            <!--导航条-->
            <a href="talk_HAction_findTeacherAllTalk?tcid=<s:property escape="false" value="pageModel.datas_c.{id}[0]"/>&pageindex=1">首页</a>
            <a href="talk_HAction_findTeacherAllTalk?tcid=<s:property escape="false" value="pageModel.datas_c.{id}[0]"/>&pageindex=<s:property value="pageindex-1"/>">上一页</a>
            <a href="talk_HAction_findTeacherAllTalk?tcid=<s:property escape="false" value="pageModel.datas_c.{id}[0]"/>&pageindex=<s:property value="pageindex+1"/>">下一页</a>
            <a href="talk_HAction_findTeacherAllTalk?tcid=<s:property escape="false" value="pageModel.datas_c.{id}[0]"/>&pageindex=<s:property value="pageModel.pagecount"/>">尾页</a>
            ...
            <div id="alltalk">
                <div class="talk">
                    ...
                    <div class="text-time">
                        ...
                        <div class="time">
                            <a href="talk_HAction_delTalk?id=<s:property value="#talk[0].id"/>">删除&nbsp&nbsp</a>
        ...
        <div class="content">
            <div class="course_introduce">
                ...
                <div id="response">
                    <form action="talk_HAction_addTalk" id="c_talk">
